...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'author', targetEntity: Liste::class, orphanRemoval: true)]
    private Collection $listes;

    #[ORM\OneToMany(mappedBy: 'author', targetEntity: Check::class, orphanRemoval: true)]
    ...
    public function removeListe(Liste $liste): self
    {
        if ($this->listes->removeElement($liste)) {
            ...
            if ($liste->getAuthor() === $this) {
                $liste->setAuthor(null);
            }
        }
    ...
    public function removeCheck(Check $check): self
    {
        if ($this->checks->removeElement($check)) {
            // set the owning side to null (unless already changed)
            if ($check->getAuthor() === $this) {
                $check->setAuthor(null);
            }
        }
